...
namespace BandTracker
{
  public class Venue
  {
    ...
    public List<Band> ViewBands()
    {
      ...
      SqlCommand cmd = new SqlCommand("SELECT bands.* FROM venues JOIN venuesBands ON (venues.id = venuesBands.venueId) JOIN bands ON (venuesBands.bandId = bands.id) WHERE venues.id = @venueId;", conn);
